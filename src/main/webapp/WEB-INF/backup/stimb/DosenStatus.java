...
public class DosenStatus implements Serializable {
    ...
    private Float noSkCpns;
    
    @Column(name = "no_sk_pengangkatan")
    private Float noSkPengangkatan;
    ...
    public Float getNoSkCpns() {
        return noSkCpns;
    }

    public void setNoSkCpns(Float noSkCpns) {
        this.noSkCpns = noSkCpns;
    }

    public Float getNoSkPengangkatan() {
        return noSkPengangkatan;
    }

    public void setNoSkPengangkatan(Float noSkPengangkatan) {
