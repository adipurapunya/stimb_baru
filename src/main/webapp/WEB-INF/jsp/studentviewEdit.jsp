    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row">
                <!-- /. BEGIN  -->
                <form:form action="updateStudent.do" method="POST" commandName="studentviewEdit">
                					<div class="">
                    													...
                    													<div class="panel panel-info">
							                            					...
							                            					<table class="col-md-12">	
							                            						...
							                            						<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="nim">NIM</label></td><td>&nbsp;&nbsp;</td>
																					<sec:authorize access="hasRole('Admin')">	<td><div class="controls"> <form:input path="nim" class="form-control"/></div></td> </sec:authorize>
																					<sec:authorize access="hasRole('Super Admin')">	<td><div class="controls"> <form:input path="nim" class="form-control" readonly="true"/></div></td> </sec:authorize>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																					...
																					<tr>
																						...
																						<form:select path="fieldStudy" class="form-control"> 	
																							<c:forEach items="${fieldStudyList}" var="field">
																								<form:option value="${field.nameField}" />
																							</c:forEach>
																						</form:select></div>
                                							...
                                							<div class="panel-body">	
                                								<div class="col-md-6 col-sm-6">
                    												<div class="panel panel-info">
                        												...
                        												<div class="panel-body">
                        													<table class="col-md-12">
                        													<form:hidden path="studentDetail.id" class="form-control"/>	
							                            						<div class="control-group">
																					<tr>
                                							...
                                							<div class="panel-body">	
                                								<div class="col-md-6 col-sm-6">
                    												<div class="panel panel-info">
                        												...
                        												<div class="panel-body">
							                            					<table class="col-md-12">
							                            					<form:hidden path="cardAddress.id" class="form-control"/>	
							                            						<div class="control-group">
																					<tr>
                                							...
                                							<div class="panel-body">	
                                								<div class="col-md-6 col-sm-6">
                    												<div class="panel panel-info">
                        												...
                        												<div class="panel-body">
							                            					<table class="col-md-12">
							                            					<form:hidden path="currentAddress.id" class="form-control"/>	
							                            						<div class="control-group">
																					<tr>
                                							...
                                							<div class="panel-body">
                                								<div class="col-md-6 col-sm-6">
                    												<div class="panel panel-info">
                        												<div class="panel-body">
							                            					<table class="col-md-12">
							                            					<form:hidden path="historyEducation.id" class="form-control"/>			
							                            						<div class="control-group">
																					<tr>
                                							...
                                							<div class="panel-body">	
                                								<div class="col-md-6 col-sm-6">
                    												<div class="panel panel-info">
                        												...
                        												<div class="panel-body">
							                            					<table class="col-md-12">	
							                            					<form:hidden path="parentStudent.id" class="form-control"/>
							                            						<div class="control-group">
																					<tr>
                                							...
                                							<div class="panel-body">	
                                								<div class="col-md-6 col-sm-6">
                    												<div class="panel panel-info">
                        												...
                        												<div class="panel-body">
							                            					<table class="col-md-12">
							                            					<form:hidden path="stepParentStudent.id" class="form-control"/>	
							                            						<div class="control-group">
																					<tr>
            	...
            	<div class="panel-footer">
								...
								<a href="student" class="btn btn-default"><spring:message code="student.back"/></a>
