                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#home" data-toggle="tab">Mayor List</a>
                                </li>
                                <li class=""><a href="#profile" data-toggle="tab">Add New Mayor</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade active in" id="home">
                                	<div class="panel-body">	
                                		<div class="table-responsive">
                                    		...
                                    		<tbody>
                                    		<c:forEach items="${mayorList}" var="mayor">
												<tr class="odd gradeA">
													<td>${mayor.id}</td>
													<td>${mayor.namaMayor}</td>
				
													<td class="center">
														<!-- <a href="#" style="color:black"><span class="glyphicon glyphicon-open"></span></a> -->
										  				<a href="updateMayor.do?id=${mayor.id}" style="color:black"><span class="glyphicon glyphicon-edit"></span></a>
										  				<a href="javascript:deleteContact('deleteMayor.do?id=${mayor.id}');" style="color:black"><span class="glyphicon glyphicon-remove"></span></a>
									  				</td>	
												</tr>
											</c:forEach>
                                    		</tbody>
						        ...
						        <form:form class="form-horizontal" action="mayor.do" method="POST" commandName="mayor">
                    													...
                    													<div class="panel panel-info">
							                            					...
							                            					<table class="col-md-12">	
							                            						...
							                            						<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="namaMayor">NAMA MAYOR</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> <form:input path="namaMayor" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
