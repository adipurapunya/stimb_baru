                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Field Study/Major Config
                        </div>
                        <div class="panel-body">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#home" data-toggle="tab">Major List</a>
                                </li>
                                <li class=""><a href="#profile" data-toggle="tab">Add Major</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade active in" id="home">
                                	<div class="panel-body">	
                                		<div class="table-responsive">
                                    		...
                                    		<thead>
                                        	<tr>
	                                            <th><spring:message code="fieldstudy.id"/></th>
	                                            <th><spring:message code="fieldstudy.code"/></th>
	                                            <th><spring:message code="fieldstudy.name"/></th>
	                                            <th><spring:message code="fieldstudy.description"/></th>
	                                            <th><spring:message code="fieldstudy.action"/></th>
                                        	</tr>
                                    		</thead>
                                    		<tbody>
                                    		<c:forEach items="${fieldofstudyList}" var="fieldofstudy">
												<tr class="odd gradeA">
													<td>${fieldofstudy.id}</td>
													<td>${fieldofstudy.codeField}</td>
													<td>${fieldofstudy.nameField}</td>
													<td>${fieldofstudy.description}</td>
													<td>
														<!-- <a href="#" style="color:black"><span class="glyphicon glyphicon-open"></span></a> -->
										  				<a href="updatefieldstudy.do?id=${fieldofstudy.id}" style="color:black"><span class="glyphicon glyphicon-edit"></span></a>
										  				<a href="javascript:deleteContact('deletefieldstudy.do?id=${fieldofstudy.id}');" style="color:black"><span class="glyphicon glyphicon-remove"></span></a>
									  				</td>	
												</tr>
											</c:forEach>
                                    		</tbody>
						        ...
						        <form:form class="form-horizontal" action="fieldstudy.do" method="POST" commandName="fieldofstudy">
