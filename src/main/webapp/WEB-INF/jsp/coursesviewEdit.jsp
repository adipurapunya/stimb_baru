    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row">
                <!-- /. BEGIN  -->
                <form:form action="updateCourses.do" method="POST" commandName="coursesviewEdit">
                					<div class="">
                    						...
                    						<div class="panel panel-default">
                        						...
                        						<div class="panel-body">
						                            <ul class="nav nav-tabs">
						                                ...
						                                <li class=""><a href="#detail" data-toggle="tab">Detail Course</a></li>
						                            </ul>
                                							...
                                							<div class="panel-body">	
                                								<div class="col-md-6 col-sm-6">
                    												<div class="panel panel-info">
                        												...
                        												<div class="panel-body">
                        													<table class="col-md-12">
                        													<form:hidden path="curriculum.id" class="form-control"/>	
							                            						<div class="control-group">
																					<tr>
            	...
            	<div class="panel-footer">
								...
								<a href="course" class="btn btn-default"><spring:message code="student.back"/></a>
