                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            List Mata Kuliah Config
                        </div>
                        <div class="panel-body">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#home" data-toggle="tab">List Mata Kuliah</a>
                                </li>
                                <li class=""><a href="#profile" data-toggle="tab">Add New List Mata Kuliah</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                		...
                                		<div class="table-responsive">
                                    		...
                                    		<c:forEach items="${listmatkulList}" var="listmatkul">
												<tr class="odd gradeA">
													...
													<td>${listmatkul.masterKurikulum.namaKurikulum}</td>
						        ...
						        <form:form class="form-horizontal" action="listmatkul.do" method="POST" commandName="listmatkul">
							                            					...
							                            					<table class="col-md-12">	
																				...
																				<div class="control-group">
																					<tr>
																						...
																						<td><div class="controls"> <form:input path="semester" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="matakuliahWajib">MATKUL WAJIB</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> <form:checkbox path="matakuliahWajib" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				...
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="masterKurikulum.id">NAMA KURIKULUM</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> 
																						<form:select path="masterKurikulum.id" class="form-control"> 	
																							<c:forEach items="${kurikulumList}" var="field">
																								<form:option value="${field.id}">${field.namaKurikulum}</form:option>
																							</c:forEach>
																						</form:select></div>
																						</div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				...
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="masterMatakuliah.id">NAMA MATKUL</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> 
																						<form:select path="masterMatakuliah.id" class="form-control"> 	
																							<c:forEach items="${matkulList}" var="field">
																								<form:option value="${field.id}">${field.namaMatakuliah}</form:option>
																							</c:forEach>
																						</form:select></div>
																						</div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
