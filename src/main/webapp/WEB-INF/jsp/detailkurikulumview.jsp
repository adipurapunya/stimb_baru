    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row">
                <!-- /. BEGIN  -->
                <form:form action="kurikulum.do" method="POST" commandName="detailkurikulumview">
                					<div class="">
							                            					...
							                            					<td>	
							                            						...
							                            						<div class="control-group">
																					<tr>
																						...
																						<td><div class="controls"> <form:input path="namaKurikulum" class="form-control" readonly="true"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				...
																				<div class="control-group">
																					<tr>
																						...
																						<td><div class="controls"> <form:input path="mulaiBerlaku" class="form-control" readonly="true"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				...
																				<div class="control-group">
																					<tr>
																						...
																						<td><div class="controls"> <form:input path="aturanSksLulus" class="form-control" readonly="true"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				...
																				<div class="control-group">
																					<tr>
																						...
																						<td><div class="controls"> <form:input path="aturanSksWajib" class="form-control" readonly="true"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				</table>
																			</td>
																			<td>	
																				...
																				<div class="control-group">
																					<tr>
																						...
																						<td><div class="controls"> <form:input path="aturanSksPilihan" class="form-control" readonly="true"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				...
																				<div class="control-group">
																					<tr>
																						...
																						<td><div class="controls"> <form:input path="sksMatakuliahWajib" class="form-control" readonly="true"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				...
																				<div class="control-group">
																					<tr>
																						...
																						<td><div class="controls"> <form:input path="sksMatakuliahPilihan" class="form-control" readonly="true"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				...
																				<div class="control-group">
																					<tr>
																						...
																						<td><div class="controls"> <form:input path="reffProgramStudi.namaProgramStudi" class="form-control" readonly="true"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																			</table>
																			</td>
                    												...
                    												<div class="col-md-12">
                    													<div class="panel panel-info">
                        													...
                        													<div class="panel-body">
									                                    		...
									                                    		<tbody>
									                                    		<c:forEach items="${listmatkulList}" var="listmatkul">
																					<tr class="odd gradeA">
																						
																						<td>${listmatkul.semester}</td>
																						<td>${listmatkul.matakuliahWajib}</td>
																						
																						<td>${listmatkul.masterMatakuliah.namaMatakuliah}</td>
																
																		
													
																						<td class="center">
																							<!-- <a href="#" style="color:black"><span class="glyphicon glyphicon-open"></span></a> -->
																			  				<a href="updateListmatkul.do?id=${listmatkul.id}" style="color:black"><span class="glyphicon glyphicon-edit"></span></a>
																			  				<a href="javascript:deleteContact('deleteListmatkul.do?id=${listmatkul.id}');" style="color:black"><span class="glyphicon glyphicon-remove"></span></a>
																		  				</td>	
																					</tr>
																				</c:forEach>
									                                    		</tbody>
            	...
            	<div class="panel-footer">
								...
								<a href="addMatkul?id=1" class="btn btn-default">Tambah</a>
								<a href="kurikulum" class="btn btn-default"><spring:message code="student.back"/></a>
