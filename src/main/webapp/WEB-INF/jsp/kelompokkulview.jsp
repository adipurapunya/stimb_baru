                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Kelompok Mata Kuliah Config
                        </div>
                        <div class="panel-body">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#home" data-toggle="tab">Kelompok Mata Kuliah List</a>
                                </li>
                                <li class=""><a href="#profile" data-toggle="tab">Add New Kelompok Mata Kuliah</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                	...
                                	<div class="panel-body">	
                                		<div class="table-responsive">
                                        	...
                                        	<tr>
	                                            ...
	                                            <th>NAMA KELOMPOK MATKUL</th>
	                                            <th><spring:message code="coursesparam.action"/></th>
                                        	</tr>
                                    		</thead>
                                    		<tbody>
                                    		<c:forEach items="${kelompokkulList}" var="kelompokkul">
												<tr class="odd gradeA">
													<td>${kelompokkul.id}</td>
													<td>${kelompokkul.namaKelompokMataKuliah}</td>
				
													<td class="center">
														<!-- <a href="#" style="color:black"><span class="glyphicon glyphicon-open"></span></a> -->
										  				<a href="updateKelompokkul.do?id=${kelompokkul.id}" style="color:black"><span class="glyphicon glyphicon-edit"></span></a>
										  				<a href="javascript:deleteContact('deleteKelompokkul.do?id=${kelompokkul.id}');" style="color:black"><span class="glyphicon glyphicon-remove"></span></a>
									  				</td>	
												</tr>
											</c:forEach>
                                    		</tbody>
						        ...
						        <form:form class="form-horizontal" action="kelompokkul.do" method="POST" commandName="kelompokkul">
                    													...
                    													<div class="panel panel-info">
							                            					...
							                            					<table class="col-md-12">	
							                            						...
							                            						<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="namaKelompokMataKuliah">NAMA KELOMPOK MATKUL</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> <form:input path="namaKelompokMataKuliah" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
