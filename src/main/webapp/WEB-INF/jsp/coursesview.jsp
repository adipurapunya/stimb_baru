                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#home" data-toggle="tab">Courses List</a>
                                </li>
                                <li class=""><a href="#profile" data-toggle="tab">Add New Course</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade active in" id="home">
                                	<div class="panel-body">	
                                		<div class="table-responsive">
                                    		...
                                    		<thead>
                                        	<tr>
	                                            <th><spring:message code="coursesparam.code"/></th>
	                                            <th><spring:message code="coursesparam.name"/></th>
	                                            <th><spring:message code="coursesparam.credit"/></th>
	                                            <th><spring:message code="coursesparam.mandatory"/></th>
                                    		...
                                    		<c:forEach items="${coursesList}" var="courses">
												<tr class="odd gradeA">
													...
													<td>${courses.curriculum.creditCourse}</td>
													<td>${courses.kindOfCourse}</td>
				
													<td class="center">
														<!-- <a href="#" style="color:black"><span class="glyphicon glyphicon-open"></span></a> -->
										  				<a href="updateCourses.do?id=${courses.id}" style="color:black"><span class="glyphicon glyphicon-edit"></span></a>
										  				<a href="javascript:deleteContact('deleteCourses.do?id=${courses.id}');" style="color:black"><span class="glyphicon glyphicon-remove"></span></a>
									  				</td>	
												</tr>
											</c:forEach>
                                    		</tbody>
						        ...
						        <form:form class="form-horizontal" action="courses.do" method="POST" commandName="courses">
                    						...
                    						<div class="panel panel-default">
                        						...
                        						<div class="panel-body">
						                            <ul class="nav nav-tabs">
						                                ...
						                                <li class=""><a href="#detail" data-toggle="tab">Detail Curriculum</a></li>
						                            </ul>
                    													...
                    													<div class="panel panel-info">
							                            					...
							                            					<table class="col-md-12">	
							                            						...
							                            						<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="codeCourse">KODE MATA KULIAH</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> <form:input path="codeCourse" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
												
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="nameCourse">NAMA MATA KULIAH</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> <form:input path="nameCourse" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="prerequisite">PERSYARATAN</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> <form:input path="prerequisite" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="kindOfCourse">JENIS MATA KULIAH</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls">
																						<form:select path="kindOfCourse" class="form-control"> 
																							<form:option value="Wajib" />
																							<form:option value="Pilihan" />
																						</form:select></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				...
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="groupOfCourse">KELOMPOK MATA KULIAH</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> <form:input path="groupOfCourse" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="levelOfCourse">PRODI</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> <form:input path="levelOfCourse" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																			</table>
                            												</div>
                    												...
                    												<div class="panel panel-info">
                        												...
                        												<div class="panel-body">
                        													<table class="col-md-12">	
							                            						<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="creditCourse">SKS</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> <form:input path="curriculum.creditCourse" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
													
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="faceToface">TATAP MUKA</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> <form:input path="curriculum.faceToface" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
													
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="namaawal">PRAKTIKUM</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> <form:input path="curriculum.practicum" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="practice">PRAKTEK</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> <form:input path="curriculum.practice" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="practiceField">PRAKTEK LAPANGAN</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> <form:input path="curriculum.practiceField" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																	
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="simulation">SIMULASI</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> <form:input path="curriculum.simulation" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																			
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="semester">SEMESTER</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls">
																						<form:select path="curriculum.semester" class="form-control"> 
																							<form:option value="I" />
																							<form:option value="II" />
																							<form:option value="III" />
																							<form:option value="IV" />
																							<form:option value="V" />
																							<form:option value="VI" />
																							<form:option value="VII" />
																							<form:option value="VIII" />
																							<form:option value="IX" />
																							<form:option value="X" />
																						</form:select></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
