    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
            	...
            	<div class="row">
                    <div class="col-md-12">
                     <h2>Tambah Matkul Pada Kurikulum</h2>   
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
						        ...
						        <form:form class="form-horizontal" action="kurikulum.do" method="POST" commandName="detailkurikulumAdd">
                    													...
                    													<div class="panel panel-info">
							                            					...
							                            					<table class="col-md-12">	
																				...
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="nama">NAMA KURIKULUM</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> 
																						<form:select path="masterKurikulum.id" class="form-control"> 	
																							
																								<form:option value="${kurikulumList.id}">${kurikulumList.namaKurikulum}</form:option>
                                	...
                                	<div class="modal-footer">
						        			<input type="submit" name="action" value="Add Matkul" class="btn btn-success"/>
						        			<!--<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">Batal</button> -->
											<a href="viewMk.do?id=${kurikulumList.id}" class="btn btn-default">Batal</a>
