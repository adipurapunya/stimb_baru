    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row">
                <!-- /. BEGIN  -->
                <form:form action="updateLecturer.do" method="POST" commandName="lecturerviewEdit">
                					<div class="">
                                							...
                                							<div class="panel-body">	
                                								<div class="col-md-6 col-sm-6">
                    												<div class="panel panel-info">
                        												...
                        												<div class="panel-body">
                        													<table class="col-md-12">
                        													<form:hidden path="detailLecturer.id" class="form-control"/>	
							                            						<div class="control-group">
																					<tr>
                                							...
                                							<div class="panel-body">	
                                								<div class="col-md-6 col-sm-6">
                    												<div class="panel panel-info">
                        												...
                        												<div class="panel-body">
							                            					<table class="col-md-12">
							                            					<form:hidden path="addressLecturer.id" class="form-control"/>	
							                            						<div class="control-group">
																					<tr>
                                							...
                                							<div class="panel-body">	
                                								<div class="col-md-6 col-sm-6">
                    												<div class="panel panel-info">
                        												...
                        												<div class="panel-body">
							                            					<table class="col-md-12">	
							                            					<form:hidden path="educationLecturer.id" class="form-control"/>
							                            						<div class="control-group">
																					<tr>
            	...
            	<div class="panel-footer">
								...
								<a href="lecturer" class="btn btn-default"><spring:message code="student.back"/></a>
