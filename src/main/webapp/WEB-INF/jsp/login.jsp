...
<html>
<head>
<title>STMB Bandung</title>

<meta name="Designer" content="PremiumPixels.com">
<meta name="Author" content="$hekh@r d-Ziner, CSSJUNTION.com">
<!-- 
<link  href="<c:url value='/resources/resources/login/reset.css'/>" rel="stylesheet" type="text/css"/>
<link  href="<c:url value='/resources/resources/login/structure.css'/>" rel="stylesheet" type="text/css"/>
-->
<style type="text/css">
...
<form class="box login" action="j_spring_security_check" method="POST">
	<fieldset class="boxBody">
	  ...
	  <input type="text" tabindex="1" placeholder="" required name="j_username">
