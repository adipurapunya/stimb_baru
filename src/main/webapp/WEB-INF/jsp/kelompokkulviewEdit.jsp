    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row">
                <!-- /. BEGIN  -->
                <form:form action="updateKelompokkul.do" method="POST" commandName="kelompokkulviewEdit">
                					<div class="">
            	...
            	<div class="panel-footer">
								...
								<a href="kelompokkul" class="btn btn-default"><spring:message code="student.back"/></a>
