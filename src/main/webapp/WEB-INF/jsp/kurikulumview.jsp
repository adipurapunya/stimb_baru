                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#home" data-toggle="tab">Kurikulum List</a>
                                </li>
                                <li class=""><a href="#profile" data-toggle="tab">Add New Kurikulum</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                		...
                                		<div class="table-responsive">
                                    		...
                                    		<c:forEach items="${kurikulumList}" var="kurikulum">
												<tr class="odd gradeA">
													...
													<td>${kurikulum.reffProgramStudi.namaProgramStudi}</td>
				
													<td class="center">
														<!-- <a href="#" style="color:black"><span class="glyphicon glyphicon-open"></span></a> -->
										  				<a href="viewMk.do?id=${kurikulum.id}" style="color:black">Tambah</a>
										  				<a href="updateKurikulum.do?id=${kurikulum.id}" style="color:black"><span class="glyphicon glyphicon-edit"></span></a>
										  				<a href="javascript:deleteContact('deleteKurikulum.do?id=${kurikulum.id}');" style="color:black"><span class="glyphicon glyphicon-remove"></span></a>
									  				</td>	
												</tr>
											</c:forEach>
                                    		</tbody>
						        ...
						        <form:form class="form-horizontal" action="kurikulum.do" method="POST" commandName="kurikulum">
                    													...
                    													<div class="panel panel-info">
							                            					...
							                            					<table class="col-md-12">	
							                            						...
							                            						<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="namaKurikulum">NAMA KURIKULUM</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> <form:input path="namaKurikulum" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="mulaiBerlaku">MULAI BERLAKU</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> <form:input path="mulaiBerlaku" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="aturanSksLulus">ATURAN SKS LULUS</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> <form:input path="aturanSksLulus" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="aturanSksWajib">ATURAN SKS WAJIB</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> <form:input path="aturanSksWajib" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="aturanSksPilihan">ATURAN SKS PILIHAN</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> <form:input path="aturanSksPilihan" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="sksMatakuliahWajib">SKS MATA KULIAH WAJIB</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> <form:input path="sksMatakuliahWajib" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="sksMatakuliahPilihan">SKS MATA KULIAH PILIHAN</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> <form:input path="sksMatakuliahPilihan" class="form-control"/></div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
																				</div>
																				
																				<div class="control-group">
																					<tr>
																						<td align="right"><label class="control-label" for="namaProgramStudi">PRODI</label></td><td>&nbsp;&nbsp;</td>
																						<td><div class="controls"> 
																						<form:select path="reffProgramStudi.id" class="form-control"> 	
																							<c:forEach items="${prodiList}" var="field">
																								<form:option value="${field.id}">${field.namaProgramStudi}</form:option>
																							</c:forEach>
																						</form:select></div>
																						</div></td>
																					</tr><tr><td>&nbsp;&nbsp;</td></tr>
